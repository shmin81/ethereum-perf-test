...
const getDeployedDocAddressObj = {
    "inputs":[{"name": "idx","type": "uint256"}],
    "name":"deployedAddress",
    "type":"function"
}
const gegetDeployedDocCntObj = {
    "inputs":[],
    "name":"deployedCount",
    "type":"function"
}
...
exports.deployEstimateGas = function (senderAddr) {
    const txData = {
        from: senderAddr,
        to: mgmtContractAddr,
        data: ABIHelper.getCallDataByABI(deployDocObj, [])
    }
...
exports.deployReq = function (senderKey, nonce) {
    ...
    const txData = {
        ...
        to: mgmtContractAddr,
        data: ABIHelper.getCallDataByABI(deployObj, [])
    }
...
exports.getDeployDocAddress = function (_idx) {
    ...
    const txData = {
        to: mgmtContractAddr,
        data: ABIHelper.getCallDataByABI(getDeployedDocAddressObj, [`${_idx}`])
    }
    callDocuBody.params = [txData, "latest"]
    callDocuBody.id++
    //console.log(txData)
...
exports.getDeployDocCount = function () {
    ...
    const txData = {
        to: mgmtContractAddr,
        data: ABIHelper.getCallDataByABI(gegetDeployedDocCntObj, [])
    }
    callDocuBody.params = [txData, "latest"]
    callDocuBody.id++
    //console.log(txData)
