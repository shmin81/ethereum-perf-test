...
const nodeScript = './tps1Sub_single_thread.js'
...
let remained = 600
let targetTps = 200
const apiName = 'transfer'

const args = process.argv.slice(2);
if (args[0] == undefined) {
    console.log('Wrong input params - "config-path" [ "agent_ip(localhost)" "tps(200tps)" "TestTime(600s)" ]');
    console.log('  ex) node tps1Main_single_thread.js ../configs/local.cbdc.test.json localhost 200 60');
    process.exit(2); 
}
